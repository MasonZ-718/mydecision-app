...
There’s two view:
- Bubble view（default as home page）
- List view  (can be filtered by category and sorted by time)

When click into viewing the detail of a decision, users can see:
- Decision title
- Creation date
- Next review date
- Emotion tag
...
Interaction:
- When users click into a review due decision, they enter the scheduled review flow
- When user click and hold of a non-due decision, they enter into the doubt review flow
- when user click into a plaeholder bubble (or the "+" icon in list view), they enter into the create decision flow
...
### Backend
Local storage (For MVP, in the future we can have account system and close database for extended features)
